...
{
    [TestClass]
    public abstract class ShadowPolicyWithMissingDataTests<T> : ShadowPolicyTestsBase<T>
    {
        protected override T[] ShadowValues { get { return new[] { NoValue(), Value(-1410), NoValue(), Value(123), NoValue() }; } }

        protected override Quality[] ShadowQualities { get { return new[] { Quality.None, Quality.Fair, Quality.None, Quality.Poor, Quality.None }; } }
        ...
        protected override void GivenASignalWithShadow(Granularity granularity)
        {
            ...
            client.SetData(
                shadow.Id.Value, 
                shadowData.Where(d => d.Quality != Dto.Quality.None).ToArray());
    ...
    [TestClass]
    public class ShadowPolicyWithMissingDataIntTests : ShadowPolicyWithMissingDataTests<int>
    {
        [ClassInitialize]
        public static new void ClassInitialize(TestContext testContext)
        {
            ShadowPolicyWithMissingDataTests<int>.ClassInitialize(testContext);
        }

        [ClassCleanup]
        public static new void ClassCleanup()
        {
            ShadowPolicyWithMissingDataTests<int>.ClassCleanup();
        }
    }

    [TestClass]
    public class ShadowPolicyWithMissingDataDecimalTests : ShadowPolicyWithMissingDataTests<decimal>
    {
        [ClassInitialize]
        public static new void ClassInitialize(TestContext testContext)
        {
            ShadowPolicyWithMissingDataTests<decimal>.ClassInitialize(testContext);
        }

        [ClassCleanup]
        public static new void ClassCleanup()
        {
            ShadowPolicyWithMissingDataTests<decimal>.ClassCleanup();
        }
    }

    [TestClass]
    public class ShadowPolicyWithMissingDataDoubleTests : ShadowPolicyWithMissingDataTests<double>
    {
        [ClassInitialize]
        public static new void ClassInitialize(TestContext testContext)
        {
            ShadowPolicyWithMissingDataTests<double>.ClassInitialize(testContext);
        }

        [ClassCleanup]
        public static new void ClassCleanup()
        {
            ShadowPolicyWithMissingDataTests<double>.ClassCleanup();
        }
    }

    [TestClass]
    public class ShadowPolicyWithMissingDataStringTests : ShadowPolicyWithMissingDataTests<string>
    {
        [ClassInitialize]
        public static new void ClassInitialize(TestContext testContext)
        {
            ShadowPolicyWithMissingDataTests<string>.ClassInitialize(testContext);
        }

        [ClassCleanup]
        public static new void ClassCleanup()
        {
            ShadowPolicyWithMissingDataTests<string>.ClassCleanup();
        }
    }

    [TestClass]
    public class ShadowPolicyWithMissingDataBooleanTests : ShadowPolicyWithMissingDataTests<bool>
    {
        [ClassInitialize]
        public static new void ClassInitialize(TestContext testContext)
        {
            ShadowPolicyWithMissingDataTests<bool>.ClassInitialize(testContext);
        }

        [ClassCleanup]
        public static new void ClassCleanup()
        {
            ShadowPolicyWithMissingDataTests<bool>.ClassCleanup();
        }
    }
}
