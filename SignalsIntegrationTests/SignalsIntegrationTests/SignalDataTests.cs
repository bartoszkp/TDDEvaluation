...
namespace SignalsIntegrationTests
{
    ...
    public abstract class SignalDataTests<T> : GenericTestBase<T>
    {
        ...
        public void GivenASecondSignalWithSingleBadDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Second;
            var quality = Quality.Bad;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenASecondSignalWithSinglePoorDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Second;
            var quality = Quality.Poor;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenASecondSignalWithSingleFairDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Second;
            var quality = Quality.Fair;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenASecondSignalWithSingleGoodDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Second;
            var quality = Quality.Good;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAMinuteSignalWithSingleBadDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Minute;
            var quality = Quality.Bad;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAMinuteSignalWithSinglePoorDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Minute;
            var quality = Quality.Poor;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAMinuteSignalWithSingleFairDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Minute;
            var quality = Quality.Fair;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAMinuteSignalWithSingleGoodDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Minute;
            var quality = Quality.Good;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAHourSignalWithSingleBadDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Hour;
            var quality = Quality.Bad;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAHourSignalWithSinglePoorDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Hour;
            var quality = Quality.Poor;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAHourSignalWithSingleFairDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Hour;
            var quality = Quality.Fair;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAHourSignalWithSingleGoodDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Hour;
            var quality = Quality.Good;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenADaySignalWithSingleBadDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Day;
            var quality = Quality.Bad;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenADaySignalWithSinglePoorDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Day;
            var quality = Quality.Poor;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenADaySignalWithSingleFairDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Day;
            var quality = Quality.Fair;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenADaySignalWithSingleGoodDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Day;
            var quality = Quality.Good;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAWeekSignalWithSingleBadDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Week;
            var quality = Quality.Bad;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAWeekSignalWithSinglePoorDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Week;
            var quality = Quality.Poor;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAWeekSignalWithSingleFairDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Week;
            var quality = Quality.Fair;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAWeekSignalWithSingleGoodDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Week;
            var quality = Quality.Good;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAMonthSignalWithSingleBadDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Month;
            var quality = Quality.Bad;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAMonthSignalWithSinglePoorDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Month;
            var quality = Quality.Poor;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAMonthSignalWithSingleFairDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Month;
            var quality = Quality.Fair;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAMonthSignalWithSingleGoodDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Month;
            var quality = Quality.Good;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAYearSignalWithSingleBadDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Year;
            var quality = Quality.Bad;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAYearSignalWithSinglePoorDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Year;
            var quality = Quality.Poor;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAYearSignalWithSingleFairDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Year;
            var quality = Quality.Fair;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAYearSignalWithSingleGoodDatum_WhenGettingDataUsingSingleTimestamp_ReturnsTheDatum()
        {
            var granularity = Granularity.Year;
            var quality = Quality.Good;
            GivenASignalWith(typeof(T).FromNativeType(), granularity);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenASecondSignalWithNoData_WhenGettingDataUsingSingleTimestamp_ReturnsDefaultData()
        {
            GivenASignalWith(typeof(T).FromNativeType(), Granularity.Second);
            WhenReadingData(UniversalBeginTimestamp, UniversalBeginTimestamp);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAMinuteSignalWithNoData_WhenGettingDataUsingSingleTimestamp_ReturnsDefaultData()
        {
            GivenASignalWith(typeof(T).FromNativeType(), Granularity.Minute);
            WhenReadingData(UniversalBeginTimestamp, UniversalBeginTimestamp);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAHourSignalWithNoData_WhenGettingDataUsingSingleTimestamp_ReturnsDefaultData()
        {
            GivenASignalWith(typeof(T).FromNativeType(), Granularity.Hour);
            WhenReadingData(UniversalBeginTimestamp, UniversalBeginTimestamp);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenADaySignalWithNoData_WhenGettingDataUsingSingleTimestamp_ReturnsDefaultData()
        {
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAWeekSignalWithNoData_WhenGettingDataUsingSingleTimestamp_ReturnsDefaultData()
        {
            GivenASignalWith(typeof(T).FromNativeType(), Granularity.Week);
            WhenReadingData(UniversalBeginTimestamp, UniversalBeginTimestamp);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAMonthSignalWithNoData_WhenGettingDataUsingSingleTimestamp_ReturnsDefaultData()
        {
            GivenASignalWith(typeof(T).FromNativeType(), Granularity.Month);
            WhenReadingData(UniversalBeginTimestamp, UniversalBeginTimestamp);
        ...
        [TestMethod]
        [TestCategory("issue17")]
        public void GivenAYearSignalWithNoData_WhenGettingDataUsingSingleTimestamp_ReturnsDefaultData()
        {
            GivenASignalWith(typeof(T).FromNativeType(), Granularity.Year);
            WhenReadingData(UniversalBeginTimestamp, UniversalBeginTimestamp);
