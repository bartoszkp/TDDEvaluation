...
namespace ExampleSignalClient
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            // client.Add(new Signal() { DataType = DataType.Double, Granularity = Granularity.Month, Path = new Path { Components = new[] { "b" } } });
            ...
            var result = client.GetData(1, new DateTime(1999, 11, 1), new DateTime(2000, 4, 1));
