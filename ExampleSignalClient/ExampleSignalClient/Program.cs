    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            client.SetData(fetchedSignal.Id.GetValueOrDefault(), new Datum[]
            {
               ...
               new Datum() { Quality = Quality.Good, Timestamp = new DateTime(2000, 1, 1,3,6,1), Value = (double)2.5 }
            });




            var result = client.GetData(fetchedSignal.Id.GetValueOrDefault(), new DateTime(2000, 1, 1,1,1,1), new DateTime(2000, 1, 1,1,5,1));
