    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            var newSignal = new Signal()
            {
                ...
                Path = new Path() { Components = new[] { "root", "defaultPolicy531" } }
            };
            ...
            client.SetData(signalId, new Datum[]
            {
                    ...
                    new Datum() { Quality = Quality.Good, Timestamp = new DateTime(2003, 1, 8, 1, 1, 1), Value = (double)22 },
                    new Datum() { Quality = Quality.Good, Timestamp = new DateTime(2003, 1, 15, 1, 1, 1), Value = (double)5 },
                    new Datum() { Quality = Quality.Good, Timestamp = new DateTime(2003, 1, 29, 1, 1, 1), Value = (double)3}
            });
