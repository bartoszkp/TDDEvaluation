    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Signal signal = new Signal()
            {
                ...
                Path = new Path() { Components = new[] { "x" + random.Next(100), "y" } }
            };
            ...
            var result = client.GetData(fetchedSignal.Id.GetValueOrDefault(), new DateTime(2000, 1, 1), new DateTime(2000, 3, 1));
