...
namespace Domain.MissingValuePolicy
{
    ...
    public abstract class MissingValuePolicy<T> : MissingValuePolicyBase
    {
        ...
        public virtual IEnumerable<Datum<T>> SetMissingValue(Signal signal, IEnumerable<Datum<T>> datums, DateTime fromIncludedUtc, DateTime toExcludedUtc, Datum<T> earlierDatum)
