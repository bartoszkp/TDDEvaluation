...
namespace WebService.Tests
{
    namespace WebService.Tests
    {
        ...
        public class SignalsWebServiceTests
        {
            ...
            [TestMethod]
            public void GivenASignal_WhenGettingCoarseDataWithEqualFromAndToTimeStamps_ReturnsOneDatumWithFromTimeStamp()
            {
                SetupWebService();
                int id = 6;
                ...
                Assert.AreEqual(1, result.Count());
                Assert.AreEqual(dateFrom, result.Single().Timestamp);
            }
            ...
            [TestMethod]
            public void GivenASignal_WhenGettingCoarseData_ReturnsDataWithTimeStampsBasedOnGivenGranularity()
            {
                SetupWebService();
                int id = 6;
                ...
                Assert.AreEqual(2, result.Count());
                Assert.AreEqual(dateFrom, result.First().Timestamp);
                Assert.AreEqual(new DateTime(2000, 5, 8), result.Skip(1).First().Timestamp);
            }
