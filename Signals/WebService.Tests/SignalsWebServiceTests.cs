    ...
    namespace WebService.Tests
    {
        ...
        public class SignalsWebServiceTests
        {
            ...
            public void GivenASignalAndDatumWithMissingData_WhenGettingData_FilledDatumIsReturned()
            {
                ...
                signalsDataRepositoryMock
                    .Setup(sdrm => sdrm.GetData<double>(existingSignal, existingDatum.First().Timestamp, existingDatum.Last().Timestamp))
            ...
            public void GivenASignalAndDayDatumWithMissingData_WhenGettingData_FilledDatumIsReturned()
            {
                ...
                {
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 1, 1, 1),  Value = (double)1.5 },
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 3, 1, 1, 1),  Value = (double)2.5 }
                };

                var filledDatum = new Dto.Datum[]
                {
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 1, 1, 1),  Value = (double)1.5 },
                    new Dto.Datum {Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 2, 1, 1, 1),  Value = default(double)},
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 3, 1, 1, 1),  Value = (double)2.5 }
                };
            ...
            public void GivenASignalAndWeekDatumWithMissingData_WhenGettingData_FilledDatumIsReturned()
            {
                ...
                {
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 1, 1, 1),  Value = (double)1.5 },
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 15, 1, 1, 1),  Value = (double)2.5 }
                };

                var filledDatum = new Dto.Datum[]
                {
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 1, 1, 1),  Value = (double)1.5 },
                    new Dto.Datum {Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 8, 1, 1, 1),  Value = default(double)},
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 15, 1, 1, 1),  Value = (double)2.5 }
                };
            ...
            public void GivenASignalAndYearDatumWithMissingData_WhenGettingData_FilledDatumIsReturned()
            {
                ...
                {
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 1, 1, 1),  Value = (double)1.5 },
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2002, 1, 1, 1, 1, 1),  Value = (double)2.5 }
                };

                var filledDatum = new Dto.Datum[]
                {
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 1, 1, 1),  Value = (double)1.5 },
                    new Dto.Datum {Quality = Dto.Quality.None, Timestamp = new DateTime(2001, 1, 1, 1, 1, 1),  Value = default(double)},
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2002, 1, 1, 1, 1, 1),  Value = (double)2.5 }
                };
            ...
            public void GivenASignalAndMonthDatumWithMissingData_WhenGettingData_FillsDataFromIncludedUtcToExcludedUtc()
            {
                ...
                {
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1),  Value = (double)1.5 },
                    new Dto.Datum {Quality = Dto.Quality.Good, Timestamp = new DateTime(2002, 2, 1),  Value = (double)2.5 }
                };
