            ...
            { 
                case Granularity.Second:
                    ...
                    dataRepoMock
                        ...
                        .Returns(new List<Datum<int>>()
                        {
                            new Datum<int>() { Quality = Quality.None, Signal = returnedSignal, Timestamp = leftNoneDatumTimestamp.AddSeconds(-1), Value = default(int) }
                        });
                    ...
                    dataRepoMock
                        ...
                        .Returns(new List<Datum<int>>()
                        {
                            new Datum<int>() { Quality = Quality.None, Signal = returnedSignal, Timestamp = rightNoneDatumTimestamp.AddSeconds(1), Value = default(int) }
                        });
                ...
                case Granularity.Minute:
                    ...
                    dataRepoMock
                        ...
                        .Returns(new List<Datum<int>>()
                        {
                            new Datum<int>() { Quality = Quality.None, Signal = returnedSignal, Timestamp = leftNoneDatumTimestamp.AddMinutes(-1), Value = default(int) }
                        });
                    ...
                    dataRepoMock
                        ...
                        .Returns(new List<Datum<int>>()
                        {
                            new Datum<int>() { Quality = Quality.None, Signal = returnedSignal, Timestamp = rightNoneDatumTimestamp.AddMinutes(1), Value = default(int) }
                        });
                ...
                case Granularity.Day:
                    ...
                    dataRepoMock
                        ...
                        .Returns(new List<Datum<int>>()
                        {
                            new Datum<int>() { Quality = Quality.None, Signal = returnedSignal, Timestamp = leftNoneDatumTimestamp.AddDays(-1), Value = default(int) }
                        });
                    ...
                    dataRepoMock
                        ...
                        .Returns(new List<Datum<int>>()
                        {
                            new Datum<int>() { Quality = Quality.None, Signal = returnedSignal, Timestamp = rightNoneDatumTimestamp.AddDays(1), Value = default(int) }
                        });
                ...
                case Granularity.Week:
                    ...
                    dataRepoMock
                        ...
                        .Returns(new List<Datum<int>>()
                        {
                            new Datum<int>() { Quality = Quality.None, Signal = returnedSignal, Timestamp = leftNoneDatumTimestamp.AddDays(-7), Value = default(int) }
                        });
                    ...
                    dataRepoMock
                        ...
                        .Returns(new List<Datum<int>>()
                        {
                            new Datum<int>() { Quality = Quality.None, Signal = returnedSignal, Timestamp = rightNoneDatumTimestamp.AddDays(7), Value = default(int) }
                        });
                ...
                case Granularity.Year:
                    ...
                    dataRepoMock
                        ...
                        .Returns(new List<Datum<int>>()
                        {
                            new Datum<int>() { Quality = Quality.None, Signal = returnedSignal, Timestamp = leftNoneDatumTimestamp.AddYears(-1), Value = default(int) }
                        });
                    ...
                    dataRepoMock
                        ...
                        .Returns(new List<Datum<int>>()
                        {
                            new Datum<int>() { Quality = Quality.None, Signal = returnedSignal, Timestamp = rightNoneDatumTimestamp.AddYears(1), Value = default(int) }
                        });
