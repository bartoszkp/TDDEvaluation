...
namespace WebService.Tests
{
    ...
    public class FirstOrderFillTests
    {
        ...
        [TestMethod]
        public void GivenAnIntegerMonthlySignal_WhenGettingDataWithCorrectRange_LowerQualityShouldFillMissingData()
        {
        ...
        [TestMethod]
        public void GivenAnIntegerYearSignal_WhenGettingDataWithCorrectRange_LowerQualityShouldFillMissingData()
        {
            SetupFirstOrderPolicyForLowerQuality(Granularity.Year, new DateTime(2000, 1, 1), new DateTime(2006, 1, 1), new List<Datum<int>>()
            {
                new Datum<int>() { Quality = Quality.Bad, Timestamp = new DateTime(2000, 1, 1), Value = (int)10 },
                new Datum<int>() { Quality = Quality.Fair, Timestamp = new DateTime(2005, 1, 1), Value = (int)30 }
            });
            ...
            var expectedDatum = new List<Dto.Datum>()
            {
                new Dto.Datum() { Quality = Dto.Quality.Bad, Timestamp = new DateTime(2001, 1, 1), Value = (int)10 },
                new Dto.Datum() { Quality = Dto.Quality.Bad, Timestamp = new DateTime(2002, 1, 1), Value = (int)20 },
                new Dto.Datum() { Quality = Dto.Quality.Bad, Timestamp = new DateTime(2003, 1, 1), Value = (int)20 },
                new Dto.Datum() { Quality = Dto.Quality.Bad, Timestamp = new DateTime(2004, 1, 1), Value = (int)25 },
                new Dto.Datum() { Quality = Dto.Quality.Fair, Timestamp = new DateTime(2005, 1, 1), Value = (int)30 },
            };
        ...
        {
            SetupFirstOrderPolicyForLowerQuality(Granularity.Year, new DateTime(2001, 1, 1), new DateTime(2006, 1, 1), new List<Datum<int>>()
            {
                new Datum<int>() { Quality = Quality.Bad, Timestamp = new DateTime(2001, 1, 1), Value = (int)10 },
                new Datum<int>() { Quality = Quality.Fair, Timestamp = new DateTime(2005, 1, 1), Value = (int)30 }
            });
        ...
        private void SetupGetDataOlderAndNewerThanForSignalForSpecificExample(Signal returnedSignal)
        {
            ...
            DateTime rightFairDatumTimestamp;
            ...
            switch (returnedSignal.Granularity)
            {
                case Granularity.Day:
                    ...
                    rightFairDatumTimestamp = new DateTime(2000, 1, 5, 0, 0, 0);
                    ...
                    dataRepoMock
                       .Setup(d => d.GetDataOlderThan<int>(returnedSignal, leftBadDatumTimestamp.AddDays(1), 1))
                       .Returns(new List<Datum<int>>());

                    dataRepoMock
                       .Setup(d => d.GetDataNewerThan<int>(returnedSignal, leftBadDatumTimestamp.AddDays(1), 1))
                       .Returns(new List<Datum<int>>()
                       {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleFirstBadDatumTimestamp, Value = (int)15 }
                       });
                    ...
                    dataRepoMock
                       .Setup(d => d.GetDataNewerThan<int>(returnedSignal, rightFairDatumTimestamp, 1))
                       .Returns(new List<Datum<int>>());
                    ...
                    dataRepoMock
                       .Setup(d => d.GetDataNewerThan<int>(returnedSignal, rightFairDatumTimestamp.AddDays(-1), 1))
                       .Returns(new List<Datum<int>>());

                    dataRepoMock
                       .Setup(d => d.GetDataOlderThan<int>(returnedSignal, rightFairDatumTimestamp.AddDays(-1), 1))
                       .Returns(new List<Datum<int>>()
                       {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleThirdBadDatumTimestamp, Value = (int)25 }
                       });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataNewerThan<int>(returnedSignal, middleFirstBadDatumTimestamp.AddDays(1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleSecondBadDatumTimestamp, Value = (int)20 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataOlderThan<int>(returnedSignal, middleSecondBadDatumTimestamp.AddDays(-1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleFirstBadDatumTimestamp, Value = (int)15 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataNewerThan<int>(returnedSignal, middleSecondBadDatumTimestamp.AddDays(1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleThirdBadDatumTimestamp, Value = (int)25 }
                        });
                    ...
                    dataRepoMock
                        ...
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleSecondBadDatumTimestamp, Value = (int)15 }
                        });

                    dataRepoMock
                        .Setup(d => d.GetDataOlderThan<int>(returnedSignal, middleThirdBadDatumTimestamp.AddDays(-1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleSecondBadDatumTimestamp, Value = (int)15 }
                        });
                ...
                case Granularity.Second:
                    ...
                    dataRepoMock
                       .Setup(d => d.GetDataOlderThan<int>(returnedSignal, leftBadDatumTimestamp.AddSeconds(1), 1))
                       .Returns(new List<Datum<int>>());

                    dataRepoMock
                       .Setup(d => d.GetDataNewerThan<int>(returnedSignal, leftBadDatumTimestamp.AddSeconds(1), 1))
                       .Returns(new List<Datum<int>>()
                       {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleFirstBadDatumTimestamp, Value = (int)15 }
                       });
                    ...
                    dataRepoMock
                       .Setup(d => d.GetDataNewerThan<int>(returnedSignal, rightFairDatumTimestamp.AddSeconds(-1), 1))
                       .Returns(new List<Datum<int>>());

                    dataRepoMock
                       .Setup(d => d.GetDataOlderThan<int>(returnedSignal, rightFairDatumTimestamp.AddSeconds(-1), 1))
                       .Returns(new List<Datum<int>>()
                       {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleThirdBadDatumTimestamp, Value = (int)25 }
                       });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataNewerThan<int>(returnedSignal, middleFirstBadDatumTimestamp.AddSeconds(1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleSecondBadDatumTimestamp, Value = (int)20 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataOlderThan<int>(returnedSignal, middleSecondBadDatumTimestamp.AddSeconds(-1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleFirstBadDatumTimestamp, Value = (int)15 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataNewerThan<int>(returnedSignal, middleSecondBadDatumTimestamp.AddSeconds(1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleThirdBadDatumTimestamp, Value = (int)25 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataOlderThan<int>(returnedSignal, middleThirdBadDatumTimestamp.AddSeconds(-1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleSecondBadDatumTimestamp, Value = (int)15 }
                        });
                ...
                case Granularity.Month:
                    ...
                    dataRepoMock
                       .Setup(d => d.GetDataOlderThan<int>(returnedSignal, leftBadDatumTimestamp.AddMonths(1), 1))
                       .Returns(new List<Datum<int>>());

                    dataRepoMock
                       .Setup(d => d.GetDataNewerThan<int>(returnedSignal, leftBadDatumTimestamp.AddMonths(1), 1))
                       .Returns(new List<Datum<int>>()
                       {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleFirstBadDatumTimestamp, Value = (int)15 }
                       });
                    ...
                    dataRepoMock
                       .Setup(d => d.GetDataNewerThan<int>(returnedSignal, rightFairDatumTimestamp.AddMonths(-1), 1))
                       .Returns(new List<Datum<int>>());

                    dataRepoMock
                       .Setup(d => d.GetDataOlderThan<int>(returnedSignal, rightFairDatumTimestamp.AddMonths(-1), 1))
                       .Returns(new List<Datum<int>>()
                       {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleThirdBadDatumTimestamp, Value = (int)25 }
                       });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataNewerThan<int>(returnedSignal, middleFirstBadDatumTimestamp.AddMonths(1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleSecondBadDatumTimestamp, Value = (int)20 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataOlderThan<int>(returnedSignal, middleSecondBadDatumTimestamp.AddMonths(-1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleFirstBadDatumTimestamp, Value = (int)15 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataNewerThan<int>(returnedSignal, middleSecondBadDatumTimestamp.AddMonths(1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleThirdBadDatumTimestamp, Value = (int)25 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataOlderThan<int>(returnedSignal, middleThirdBadDatumTimestamp.AddMonths(-1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleSecondBadDatumTimestamp, Value = (int)15 }
                        });
                ...
                case Granularity.Year:
                    leftBadDatumTimestamp = new DateTime(2001, 1, 1);
                    middleFirstBadDatumTimestamp = new DateTime(2002, 1, 1);
                    middleSecondBadDatumTimestamp = new DateTime(2003, 1, 1);
                    middleThirdBadDatumTimestamp = new DateTime(2004, 1, 1);
                    rightFairDatumTimestamp = new DateTime(2005, 1, 1);
                    ...
                    dataRepoMock
                       .Setup(d => d.GetDataOlderThan<int>(returnedSignal, leftBadDatumTimestamp.AddYears(1), 1))
                       .Returns(new List<Datum<int>>());

                    dataRepoMock
                       .Setup(d => d.GetDataNewerThan<int>(returnedSignal, leftBadDatumTimestamp.AddYears(1), 1))
                       .Returns(new List<Datum<int>>()
                       {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleFirstBadDatumTimestamp, Value = (int)15 }
                       });
                    ...
                    dataRepoMock
                       .Setup(d => d.GetDataNewerThan<int>(returnedSignal, rightFairDatumTimestamp.AddYears(-1), 1))
                       .Returns(new List<Datum<int>>());

                    dataRepoMock
                       .Setup(d => d.GetDataOlderThan<int>(returnedSignal, rightFairDatumTimestamp.AddYears(-1), 1))
                       .Returns(new List<Datum<int>>()
                       {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleThirdBadDatumTimestamp, Value = (int)25 }
                       });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataNewerThan<int>(returnedSignal, middleFirstBadDatumTimestamp.AddYears(1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleSecondBadDatumTimestamp, Value = (int)20 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataOlderThan<int>(returnedSignal, middleSecondBadDatumTimestamp.AddYears(-1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleFirstBadDatumTimestamp, Value = (int)15 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataNewerThan<int>(returnedSignal, middleSecondBadDatumTimestamp.AddYears(1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleThirdBadDatumTimestamp, Value = (int)25 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataOlderThan<int>(returnedSignal, middleThirdBadDatumTimestamp.AddYears(-1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleSecondBadDatumTimestamp, Value = (int)15 }
                        });
                ...
                case Granularity.Hour:
                    ...
                    middleFirstBadDatumTimestamp = new DateTime(2000, 1, 1, 2, 1, 1);
                    middleSecondBadDatumTimestamp = new DateTime(2000, 1, 1, 3, 1, 1);
                    middleThirdBadDatumTimestamp = new DateTime(2000, 1, 1, 4, 1, 1);
                    rightFairDatumTimestamp = new DateTime(2000, 1, 1, 5, 1, 1);
                    ...
                    dataRepoMock
                       .Setup(d => d.GetDataOlderThan<int>(returnedSignal, leftBadDatumTimestamp.AddHours(1), 1))
                       .Returns(new List<Datum<int>>());

                    dataRepoMock
                       .Setup(d => d.GetDataNewerThan<int>(returnedSignal, leftBadDatumTimestamp.AddHours(1), 1))
                       .Returns(new List<Datum<int>>()
                       {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleFirstBadDatumTimestamp, Value = (int)15 }
                       });
                    ...
                    dataRepoMock
                       .Setup(d => d.GetDataNewerThan<int>(returnedSignal, rightFairDatumTimestamp.AddHours(-1), 1))
                       .Returns(new List<Datum<int>>());

                    dataRepoMock
                       .Setup(d => d.GetDataOlderThan<int>(returnedSignal, rightFairDatumTimestamp.AddHours(-1), 1))
                       .Returns(new List<Datum<int>>()
                       {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleThirdBadDatumTimestamp, Value = (int)25 }
                       });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataNewerThan<int>(returnedSignal, middleFirstBadDatumTimestamp.AddHours(1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleSecondBadDatumTimestamp, Value = (int)20 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataOlderThan<int>(returnedSignal, middleSecondBadDatumTimestamp.AddHours(-1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleFirstBadDatumTimestamp, Value = (int)15 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataNewerThan<int>(returnedSignal, middleSecondBadDatumTimestamp.AddHours(1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleThirdBadDatumTimestamp, Value = (int)25 }
                        });
                    ...
                    dataRepoMock
                        .Setup(d => d.GetDataOlderThan<int>(returnedSignal, middleThirdBadDatumTimestamp.AddHours(-1), 1))
                        .Returns(new List<Datum<int>>()
                        {
                                        new Datum<int>() { Quality = Quality.Bad, Signal = returnedSignal, Timestamp = middleSecondBadDatumTimestamp, Value = (int)15 }
                        });
