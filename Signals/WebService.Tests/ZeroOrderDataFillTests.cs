...
namespace WebService.Tests
{
    ...
    public class ZeroOrderDataFillTests
    {
        ...
        [TestMethod]
        public void NoPreviousDatumForSecondSignal_DefaultDatumIsInserted()
        {
            SetupMockRepositories(Granularity.Second, 1, new DateTime(2000, 1, 1, 0, 0, 1), new DateTime(2000, 1, 1, 0, 0, 5),
                new List<Datum<double>>(), new DateTime(2000, 1, 1, 0, 0, 1));
            ...
            {
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 1, 0, 0, 1), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 1, 0, 0, 2), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 1, 0, 0, 3), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 1, 0, 0, 4), Value = default(double) },
            };
        ...
        [TestMethod]
        public void NoPreviousDatumForHourSignal_DefaultDatumIsInserted()
        {
            SetupMockRepositories(Granularity.Hour, 1, new DateTime(2000, 1, 1, 1, 0, 0), new DateTime(2000, 1, 1, 5, 0, 0),
                new List<Datum<double>>(), new DateTime(2000, 1, 1, 1, 0, 0));

            var result = signalsWebService.GetData(1, new DateTime(2000, 1, 1, 1, 0, 0), new DateTime(2000, 1, 1, 5, 0, 0));
            var expectedDatum = new List<Dto.Datum>()
            {
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 1, 1, 0, 0), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 1, 2, 0, 0), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 1, 3, 0, 0), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 1, 4, 0, 0), Value = default(double) },
            };
        ...
        [TestMethod]
        public void NoPreviousDatumForDailySignal_DefaultDatumIsInserted()
        {
            ...
            var expectedDatum = new List<Dto.Datum>()
            {
                ...
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 2, 0, 0, 0), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 3, 0, 0, 0), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 4, 0, 0, 0), Value = default(double) },
            };
        ...
        [TestMethod]
        public void NoPreviousDatumForWeekSignal_DefaultDatumIsInserted()
        {
            SetupMockRepositories(Granularity.Week, 1, new DateTime(2000, 1, 3, 0, 0, 0), new DateTime(2000, 1, 31, 0, 0, 0),
                new List<Datum<double>>(), new DateTime(2000, 1, 3, 0, 0, 0));

            var result = signalsWebService.GetData(1, new DateTime(2000, 1, 3, 0, 0, 0), new DateTime(2000, 1, 31, 0, 0, 0));
            var expectedDatum = new List<Dto.Datum>()
            {
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 3, 0, 0, 0), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 10, 0, 0, 0), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 17, 0, 0, 0), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 24, 0, 0, 0), Value = default(double) },
            };
        ...
        public void NoPreviousDatumForYearSignal_DefaultDatumIsInserted()
        {
            ...
            var result = signalsWebService.GetData(1, new DateTime(2000, 1, 1, 0, 0, 0), new DateTime(2004, 1, 1, 0, 0, 0));
            var expectedDatum = new List<Dto.Datum>()
            {
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2000, 1, 1, 0, 0, 0), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2001, 1, 1, 0, 0, 0), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2002, 1, 1, 0, 0, 0), Value = default(double) },
                new Dto.Datum() { Quality = Dto.Quality.None, Timestamp = new DateTime(2003, 1, 1, 0, 0, 0), Value = default(double) },
            };
        ...
        {
            SetupMockRepositories(Granularity.Second, 1, new DateTime(2000, 1, 1, 0, 0, 5), new DateTime(2000, 1, 1, 0, 0, 9),
                new List<Datum<double>>() { new Datum<double>() { Quality = Quality.Good, Timestamp = new DateTime(2000, 1, 1, 0, 0, 1), Value = 2.5 } },
                new DateTime(2000, 1, 1, 0, 0, 5));
            
            var result = signalsWebService.GetData(1, new DateTime(2000, 1, 1, 0, 0, 5), new DateTime(2000, 1, 1, 0, 0, 9));
            var expectedDatum = new List<Dto.Datum>()
            {
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 0, 0, 5), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 0, 0, 6), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 0, 0, 7), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 0, 0, 8), Value = (double)2.5 },
            };
        ...
        {
            SetupMockRepositories(Granularity.Minute, 1, new DateTime(2000, 1, 1, 0, 5, 0), new DateTime(2000, 1, 1, 0, 9, 0),
            ...
            var result = signalsWebService.GetData(1, new DateTime(2000, 1, 1, 0, 5, 0), new DateTime(2000, 1, 1, 0, 9, 0));
            var expectedDatum = new List<Dto.Datum>()
            {
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 0, 5, 0), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 0, 6, 0), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 0, 7, 0), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 0, 8, 0), Value = (double)2.5 },
            };
        ...
        [TestMethod]
        public void GivenAnHourSignal_WhenGettingDataFromMoreThanOneStepOlder_WithZeroPolicy_ItCorrectlyFillsMissingData()
        {
            SetupMockRepositories(Granularity.Hour, 1, new DateTime(2000, 1, 1, 5, 0, 0), new DateTime(2000, 1, 1, 9, 0, 0),
                new List<Datum<double>>() { new Datum<double>() { Quality = Quality.Good, Timestamp = new DateTime(2000, 1, 1, 1, 0, 0), Value = 2.5 } },
                new DateTime(2000, 1, 1, 5, 0, 0));

            var result = signalsWebService.GetData(1, new DateTime(2000, 1, 1, 5, 0, 0), new DateTime(2000, 1, 1, 9, 0, 0));
            var expectedDatum = new List<Dto.Datum>()
            {
                ...
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 7, 0, 0), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 1, 1, 8, 0, 0), Value = (double)2.5 },
            };
        ...
        [TestMethod]
        public void GivenAWeekSignal_WhenGettingDataFromMoreThanOneStepOlder_WithZeroPolicy_ItCorrectlyFillsMissingData()
        {
            SetupMockRepositories(Granularity.Week, 1, new DateTime(2000, 1, 17, 0, 0, 0), new DateTime(2000, 2, 14, 0, 0, 0),
                new List<Datum<double>>() { new Datum<double>() { Quality = Quality.Good, Timestamp = new DateTime(2000, 1, 3, 0, 0, 0), Value = 2.5 } },
                new DateTime(2000, 1, 17, 0, 0, 0));

            var result = signalsWebService.GetData(1, new DateTime(2000, 1, 17, 0, 0, 0), new DateTime(2000, 2, 14, 0, 0, 0));
            var expectedDatum = new List<Dto.Datum>()
            {
        ...
        {
            SetupMockRepositories(Granularity.Month, 1, new DateTime(2000, 5, 1, 0, 0, 0), new DateTime(2000, 9, 1, 0, 0, 0),
                new List<Datum<double>>() { new Datum<double>() { Quality = Quality.Good, Timestamp = new DateTime(2000, 1, 1, 0, 0, 0), Value = 2.5 } },
                new DateTime(2000, 5, 1, 0, 0, 0));

            var result = signalsWebService.GetData(1, new DateTime(2000, 5, 1, 0, 0, 0), new DateTime(2000, 9, 1, 0, 0, 0));
            var expectedDatum = new List<Dto.Datum>()
            {
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 5, 1, 0, 0, 0), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 6, 1, 0, 0, 0), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 7, 1, 0, 0, 0), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2000, 8, 1, 0, 0, 0), Value = (double)2.5 },
            };
        ...
        [TestMethod]
        public void GivenAYearSignal_WhenGettingDataFromMoreThanOneStepOlder_WithZeroPolicy_ItCorrectlyFillsMissingData()
        {
            SetupMockRepositories(Granularity.Year, 1, new DateTime(2005, 1, 1, 0, 0, 0), new DateTime(2009, 1, 1, 0, 0, 0),
                new List<Datum<double>>() { new Datum<double>() { Quality = Quality.Good, Timestamp = new DateTime(2000, 1, 1, 0, 0, 0), Value = 2.5 } },
                new DateTime(2005, 1, 1, 0, 0, 0));

            var result = signalsWebService.GetData(1, new DateTime(2005, 1, 1, 0, 0, 0), new DateTime(2009, 1, 1, 0, 0, 0));
            var expectedDatum = new List<Dto.Datum>()
            {
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2005, 1, 1, 0, 0, 0), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2006, 1, 1, 0, 0, 0), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2007, 1, 1, 0, 0, 0), Value = (double)2.5 },
                new Dto.Datum() { Quality = Dto.Quality.Good, Timestamp = new DateTime(2008, 1, 1, 0, 0, 0), Value = (double)2.5 },
            };
